                  ...
                  <div
                    ...
                    className={`px-3 py-2 rounded-md border transition-all duration-200 ${
                      template.type === "sendEmail"
                        ? "bg-blue-50 border-blue-200 text-blue-700 hover:bg-blue-100 cursor-grab"
                        : template.type === "wait"
                          ? "bg-yellow-50 border-yellow-200 text-yellow-700 hover:bg-yellow-100 cursor-grab"
                          : template.type === "condition"
                            ? "bg-purple-50 border-purple-200 text-purple-700 hover:bg-purple-100 cursor-grab"
                            : "bg-red-50 border-red-200 text-red-700 hover:bg-red-100 cursor-grab"
                    }`}
                  >
            ...
            return (
              <div
                ...
                className={`w-10 h-10 rounded-lg border-2 border-dashed flex items-center justify-center transition-all ${
                  template.type === "sendEmail"
                    ? "bg-blue-50 border-blue-300 hover:bg-blue-100 hover:border-blue-400 cursor-grab"
                    : template.type === "wait"
                      ? "bg-yellow-50 border-yellow-300 hover:bg-yellow-100 hover:border-yellow-400 cursor-grab"
                      : template.type === "condition"
                        ? "bg-purple-50 border-purple-300 hover:bg-purple-100 hover:border-purple-400 cursor-grab"
                        : "bg-red-50 border-red-300 hover:bg-red-100 hover:border-red-400 cursor-grab"
                }`}
